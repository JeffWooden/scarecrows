...
data merge entity @s {DisabledSlots:2500134,NoBasePlate:1b,ShowArms:1b,Pose:{LeftLeg:[0f,0f,10f],RightLeg:[0f,0f,350f],LeftArm:[280f,270f,0f],RightArm:[274f,90f,0f]}}

...
execute store result entity @e[distance=..0.1,limit=1,sort=nearest] Motion[0] double 0.01 run scoreboard players operation x2 jw_sc_calc -= x1 jw_sc_calc
data modify entity @e[distance=..0.1,limit=1,sort=nearest] Motion[1] set value 0.25d
execute store result entity @e[distance=..0.1,limit=1,sort=nearest] Motion[2] double 0.01 run scoreboard players operation z2 jw_sc_calc -= z1 jw_sc_calc
